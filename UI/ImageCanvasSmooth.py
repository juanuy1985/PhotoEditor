...
from Processing.Smooth import getSmooth
from kivy.core.window import Window
import os.path

class ImageCanvasSmooth(Widget):

    def __init__(self, **args):
        super(ImageCanvasSmooth, self).__init__(**args)
        self._fileName = ''
    ...
    def process(self):
        ...
        if os.path.isfile(self.fileName) :    
            ...
            self.processSmooth(self.fileName, processedFile)
    ...
    def processSmooth(self, fileName, processedFileName):
        profiled = getSmooth(fileName)
