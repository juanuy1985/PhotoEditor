...
from Processing.Projection import getProjection
from kivy.core.window import Window
import os.path

class ImageCanvasProjection(Widget):

    def __init__(self, **args):
        super(ImageCanvasProjection, self).__init__(**args)
        self._fileName = ''
    ...
    def process(self):
        ...
        if os.path.isfile(self.fileName) :    
            ...
            self.processProjection(self.fileName, processedFile)
    ...
    def processProjection(self, fileName, processedFileName):
        profiled = getProjection(fileName)
